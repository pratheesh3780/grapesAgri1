...
if(input$submit > 0){
     ...
     kable(trtmeans,caption = "Treatment mean and other statistics",digits=3,align='c',row.names = TRUE)
}
tags$br()
################anova table
...
if(input$submit > 0){
      ...
      kable(final,caption = "ANOVA TABLE",digits=3,align='c',row.names = FALSE)
}
tags$br()
##############################################SEM
if(input$submit > 0){
        ...
        kable(Result,caption = "SEM & Other statistics",digits=3,align='c')
        }
tags$br()
if(input$submit > 0){
      d=as.data.frame(csvfile())
     ...
     if(result[1,5]>0.05){cat("Treatment means are not significantly different")
      }
    }
############################### CD and measures
tags$br()
if(input$submit > 0){
     d=as.data.frame(csvfile())
      ...
      colnames(Result)<-colnam
      kable(Result,caption = "LSD test",digits=3,align='c')
      }
        ...
        kable(Result,caption = "Tukey's HSD",digits=3,align='c')
      }  
}
tags$br()
###########################################grouping
...
tags$br()
```
Report generated from: **Package: grapes Version 1.0.0**
