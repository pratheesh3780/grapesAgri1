...
############################## Ui
 ui <- fluidPage(
  ...
  sidebarPanel(
    selectInput('design', tags$div(tags$b('Select the design for your experiment'),
                                   style="color:#d17b02"),
                c("CRD"= 'crd',
                  "RBD"='rbd',
                  "Split Plot"='split',
 ...
 server = function(input, output, session) {
  ...
  ################### CRD
   output$var_crd <- renderUI({
     if(is.null(input$design)){return()}
     if(input$design == 'crd'){
   ...
   output$text_crd1<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$trt_crd)){return()}
     if(input$design == 'crd'){
       if(input$trt_crd>=2){
         t<-input$trt_crd
         minrep.req<-((12+t)/t)
   ...
   output$details_crd<-renderTable({
     ...
     if(is.null(input$rep_crd)){return()}
     if(is.null(input$trt_crd)){return()}
     if(is.null(input$design)){return()}
   ...
   },caption=('<b> Details of the Experiment </b>'),bordered = TRUE,align='c',
...
############################# END CRD
   ...
   output$text_rbd1<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$trt_rbd)){return()}
     if(input$design == 'rbd'){
       if(input$trt_rbd>=2){
         t<-input$trt_rbd
         minrep.req<-((12/(t-1))+1)
   ...
   output$details_rbd<-renderTable({
     ...
     if(is.null(input$design)){return()}
     if(is.null(input$rep_rbd)){return()}
     if(is.null(input$trt_rbd)){return()}
...
############################# AUGMENTED RCBD
   ...
   output$text_aug1<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$check_aug)){return()}
     if(input$design == 'aug'){
   ...
   output$text_aug2<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$rep_aug)){return()}
   ...
   output$details_aug<-renderTable({
     ...
     if(is.null(input$design)){return()}
     if(is.null(input$rep_aug)){return()}
     if(is.null(input$trt_aug)){return()}
     if(is.null(input$check_aug)){return()}
     if(is.null(input$submit3)){return()}
     if(input$design == 'aug'){
...
############################################SPLIT PLOT
   output$var_split<- renderUI({
     ...
     if(input$design == 'split'){
       list (numericInput("maintrt_split",
   ...
   output$text_split1<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$maintrt_split)){return()}
     if(is.null(input$subtrt_split)){return()}
     if(input$design == 'split'){
   ...
   output$text_split2<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$rep_split)){return()}
   ...
   output$var_strip<- renderUI({
     ...
     if(input$design == 'strip'){
       list (numericInput("maintrt_strip",
   ...
   output$text_strip1<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$maintrt_strip)){return()}
     if(is.null(input$subtrt_strip)){return()}
     if(input$design == 'strip'){
   ...
   output$text_strip2<- renderUI({
     if(is.null(input$design)){return()}
     if(is.null(input$rep_strip)){return()}
...
########### layout end
  ...
  ############################# table output
   ...
   output$table_crd <- renderTable({
     if(is.null(input$design)){return()}
     if(is.null(input$trt_crd)){return()}
     if(is.null(input$table_butt1)){return()}
     if(is.null(input$rep_crd)){return()}
     if(input$design == 'crd'){
   ...
   },caption=('<b> Treatment allocation (random)</b>'),bordered = TRUE,align='c',
   caption.placement = getOption("xtable.caption.placement", "top"),rownames = FALSE)
   ...
   output$table_rbd<- renderTable({
     ...
     if(is.null(input$trt_rbd)){return()}
     if(is.null(input$rep_rbd)){return()}
     if(is.null(input$table_butt2)){return()}
     if(input$design == 'rbd'){
   ...
   output$table_aug<- renderTable({
     ...
     if(is.null(input$rep_aug)){return()}
     if(is.null(input$check_aug)){return()}
     if(is.null(input$table_butt3)){return()}
     if(input$design == 'aug'){
   ...
   output$table_split<- renderTable({
     ...
     if(is.null(input$subtrt_split)){return()}
     if(is.null(input$submit4)){return()}
     if(is.null(input$table_butt4)){return()}
     if(input$design == 'split'){
   ...
   output$table_strip<- renderTable({
     ...
     if(is.null(input$subtrt_strip)){return()}
     if(is.null(input$submit5)){return()}
     if(is.null(input$table_butt5)){return()}
     if(input$design == 'strip'){
