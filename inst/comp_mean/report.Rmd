 ...
 if(input$req1 == 'ttest'){
      if(input$submit1 > 0){
        ...
        result<-as.data.frame(result)
         kable(result,caption = "Two sample unpaired t-test",row.names = FALSE) %>% kable_styling() %>% kable_styling() %>% kable_paper("hover", full_width = F)
      }
 }
h3("")
########## note 1
...
#############################################welch ttest
 if(input$req1 == 'wttest'){
      if(input$submit2 > 0){
        ...
        result<-as.data.frame(result)
        result
        kable(result,caption = "Welch unpaired t-test",row.names = FALSE) %>% kable_styling() %>% kable_styling() %>% kable_paper("hover", full_width = F)
      }
 }
h3("")
########### note2
...
if(input$req1 == 'ottest'){
      if(input$submit3 > 0){
        ...
        result<-cbind(t_value,df,Pvalue,alt.Hypothesis)
        result<-as.data.frame(result)
        kable(result,caption = "One sample t-test",row.names = FALSE) %>% kable_styling() %>% kable_styling() %>% kable_paper("hover", full_width = F)
      }
}
h3("")
...
if(input$req1 == 'ftest'){
      if(input$submit4 > 0){
        ...
        result<-as.data.frame(result)
         kable(result,caption = "F test for Homogenity of Variance",row.names = FALSE) %>% kable_styling() %>% kable_styling() %>% kable_paper("hover", full_width = F)
      }
}
h3("")
##### note 4
...
if(input$req1 == 'pttest'){
      ...
      row.names(result1)<-NULL
       kable(round(result1,3),caption = "Paired t test",row.names = FALSE) %>% kable_styling() %>% kable_styling() %>% kable_paper("hover", full_width = F)
      }
}
h3("")
 if(input$req1 == 'pttest'){
