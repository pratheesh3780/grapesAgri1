...
ui <- fluidPage(
  ...
  titlePanel(tags$div(tags$b('Compare means: Small sample tests',style="color:#000000"))),

  sidebarPanel(
    fileInput("file1", "CSV File (upload in csv format)", accept=c("text/csv", "text/comma-separated-values,text/plain", ".csv")),
    checkboxInput("header", "Header", TRUE),
    selectInput('req1', 'Please select the analysis type',
                c("Two sample t-test" = 'ttest',
  ...
  , mainPanel(
    ...
    tableOutput('summary1'),#summary
    tags$style(  type="text/css", "#summary1 th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#summary1 td {border: medium solid #000000;text-align:center}"),
    tableOutput('ttest'),#two sample ttest
    tags$style(  type="text/css", "#ttest th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#ttest td {border: medium solid #000000;text-align:center}"),
    htmlOutput('note1'),


    tableOutput('summary2'),#summary
    tags$style(  type="text/css", "#summary2 th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#summary2 td {border: medium solid #000000;text-align:center}"),
    tableOutput('wttest'),#welch sample ttest
    tags$style(  type="text/css", "#wttest th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#wttest td {border: medium solid #000000;text-align:center}"),
    htmlOutput('note2'),


    tableOutput('summary3'),#summary
    tags$style(  type="text/css", "#summary3 th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#summary3 td {border: medium solid #000000;text-align:center}"),
    tableOutput('ottest'),#one sample ttest
    tags$style(  type="text/css", "#ottest th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#ottest td {border: medium solid #000000;text-align:center}"),
    htmlOutput('note3'),


    tableOutput('summary4'),#summary
    tags$style(  type="text/css", "#summary4 th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#summary4 td {border: medium solid #000000;text-align:center}"),
    tableOutput('ftest'),#Homogenity of variance
    tags$style(  type="text/css", "#ftest th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#ftest td {border: medium solid #000000;text-align:center}"),
    htmlOutput('note4'),


    tableOutput('summary5'),#summary
    tags$style(  type="text/css", "#summary5 th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#summary5 td {border: medium solid #000000;text-align:center}"),
    tableOutput('pttest'),#Homogenity of variance
    tags$style(  type="text/css", "#pttest th,td {border: medium solid #000000;text-align:center}"),
    tags$style(  type="text/css", "#pttest td {border: medium solid #000000;text-align:center}"),
    htmlOutput('note5'),
...
server = function(input, output, session) {
  ...
  output$var <- renderUI({
    ...
    if(input$req1 == 'ttest'){
      list (radioButtons("dvar", "Please pick 'Group A' ", choices =    names(csvfile())),
            radioButtons("ivar", "Please pick 'Group B'", choices = names(csvfile())),
            selectInput('alt', 'Alternative Hypotesis',
      ...
      list (radioButtons("dvar", "Please pick 'Group' ",
      ...
      list (radioButtons("dvar", "Please pick 'Group A' ", choices =    names(csvfile())),
            ...
            selectInput('col1', 'Colour of first box',
                        c("green" = "#00AFBB",
                          "blue"= "#3bbeff",
                          "red" = "#bf0003",
                          "yellow" = "#E7B800"
                        ...
                        ,"#00AFBB"),
            selectInput('col2', 'Colour of Second box',
                        c("green" = "#00AFBB",
                          "blue"= "#3bbeff",
                          "red" = "#bf0003",
                          "yellow" = "#E7B800"
...
############################### two sample ttest
  ...
  },rownames = FALSE,bordered = TRUE,align='c',caption=('<b>Two sample unpaired t-test </b>'),caption.placement = getOption("xtable.caption.placement", "top")
  )
...
##############################
  ...
  },rownames = FALSE,bordered = TRUE,align='c',caption=('<b>One sample t-test </b>'),caption.placement = getOption("xtable.caption.placement", "top")
  )
  ...
  output$note3<- renderUI({
    ...
    if(input$req1 == 'ottest'){
      if(input$submit3 > 0){
        ...
        if(t$p.value<=0.05){
          HTML(paste0(sprintf("Since P-value is < 0.05 we can reject the null hypothesis at 5 percent level of significance.
                    (Here null hypothesis: Population mean= %s)", mu)))
        }
        else if(t$p.value>0.05){
          HTML(paste0(sprintf("Since P-value is > 0.05 we don't have enough evidence to reject null hypothesis at 5 percent level of significance.
                    (Here null hypothesis: Population mean= %s)",mu)))
        }
      }
    }
  ...
  },rownames = FALSE,bordered = TRUE,align='c',caption=('<b>F test for Homogenity of Variance </b>'),caption.placement = getOption("xtable.caption.placement", "top")
  )
  ...
  output$note4<- renderUI({
    ...
    if(input$req1 == 'ftest'){
      if(input$submit4 > 0){
        ...
        if(f$p.value<=0.05){
          HTML(paste0("Since P-value is < 0.05 we can reject the null hypothesis at 5 percent level of significance.
                    (Here null hypothesis: Variances are Homogenous)"))
        }
        else if(f$p.value>0.05){
          HTML(paste0("Since P-value is > 0.05 we don't have enough evidence to reject null hypothesis at 5 percent level of significance. Variance is homogenous.
                    (Here null hypothesis: Variances are Homogenous)"))
        }
      }
    }
  ...
  output$plot <- renderUI({
    ...
    if(input$req1 == 'boxplot'){
      ...
      if(is.null(input$submit7)){return()}
...
########################
  ...
  output$image_down <- renderUI({
    ...
    if(input$req1 == 'boxplot'){
      ...
      if(is.null(input$submit7)){return()}
      if(input$submit7 > 0){
        list(downloadButton("downloadImage2", label="Download Paired Plot", class = "butt1"))
      }
    }
  })
  ### plotting
